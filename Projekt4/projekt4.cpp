...
GLuint shaderAttenuation0;
GLuint shaderAttenuation1;
GLuint shaderAttenuation2;
GLuint shaderAmbientColor;
GLuint shaderDiffuseColor;
GLuint shaderSpecularColor;
GLuint shaderSpecularExponent;
GLFrame cameraFrame;
...
void initialize(M3DVector3f diffuseColor){
	...
	glUniform1f(shaderAttenuation0, attenuation0);
	glUniform1f(shaderAttenuation1, attenuation1);
	glUniform1f(shaderAttenuation2, attenuation2);
	glUniform3fv(shaderAmbientColor, 1, ambientColor);
	glUniform3fv(shaderDiffuseColor, 1, diffuseColor);
	glUniform3fv(shaderSpecularColor, 1, specularColor);
	glUniform1f(shaderSpecularExponent, specularExponent);
}
...
void SetupRC() {
	...
	shaderAttenuation0 = glGetUniformLocation(shader,"light1.attenuation0");
	shaderAttenuation1 = glGetUniformLocation(shader, "light1.attenuation1");
	shaderAttenuation2 = glGetUniformLocation(shader, "light1.attenuation2");
	shaderAmbientColor = glGetUniformLocation(shader, "material.ambientColor");
	shaderDiffuseColor = glGetUniformLocation(shader, "material.diffuseColor");
	shaderSpecularColor = glGetUniformLocation(shader, "material.specularColor");
	shaderSpecularExponent = glGetUniformLocation(shader, "material.specularExponent");
...
void RenderScene(void) {
	...
	M3DVector3f eye;
	angle =timer.GetElapsedSeconds()*(M_Pi/8);
